...
import { RenderResult, RenderLayoutOptions, elementBuilder as builder } from "@glimmer/runtime";
...
export class RenderTests extends AbstractRenderTest {
  ...
  renderTemplate(template: string): RenderResult {
    ...
    let elementBuilder = builder(document, { element: this.element, nextSibling: null });
