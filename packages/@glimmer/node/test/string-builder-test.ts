...
import { Template, ElementBuilder } from '@glimmer/runtime';
import { Simple } from '@glimmer/interfaces';
import { UpdatableReference } from '@glimmer/object-reference';
import { NodeDOMTreeConstruction, stringBuilder } from '..';
...
function commonSetup() {
  ...
  env = new TestEnvironment({ document: doc });
  root = doc.createElement('div');
  elementBuilder = stringBuilder(doc, { element: root, nextSibling: null });
}
...
module("[String Builder] Server-side rendering in Node.js");
